...
Node::Node(string word):children(new AVLTree()),word(w_t_l(word)),word_count(0),pres_word(""){}
Node::Node(string word,string past):children(new AVLTree()),word(w_t_l(word)),word_count(0),pres_word(past){}
