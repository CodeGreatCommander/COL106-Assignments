...
UnlimitedInt* copy(UnlimitedInt* a,bool abs=false){
...
UnlimitedInt* UnlimitedInt::add(UnlimitedInt* a,UnlimitedInt* b){
	if(a->get_size()==0)return copy(b);if(b->get_size()==0)return copy(a);
	if(compare(a,b)){
...
UnlimitedInt* UnlimitedInt::mul(UnlimitedInt* a,UnlimitedInt* b){
	if(a->get_size()==0)return copy(a);if(b->get_size()==0)return copy(b);
...
UnlimitedInt* UnlimitedInt::div(UnlimitedInt* a,UnlimitedInt* b){
	if(b->get_size()==0){return new UnlimitedInt(0);}//handle this case
...
UnlimitedInt* UnlimitedInt::mod(UnlimitedInt* a,UnlimitedInt* b){
	UnlimitedInt *q=UnlimitedInt::div(a,b),*p=UnlimitedInt::mul(q,b),*ans=UnlimitedInt::sub(a,p);
	delete q;delete p;
	return ans;
}
