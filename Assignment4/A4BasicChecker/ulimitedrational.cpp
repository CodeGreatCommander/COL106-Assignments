...
UnlimitedInt* gcd(UnlimitedInt* a,UnlimitedInt* b){//make it so that it always receives positive a and b
	...
	// cout<<a->to_string()<<endl<<b->to_string()<<endl<<"gcd"<<endl;
...
UnlimitedRational::UnlimitedRational(UnlimitedInt*a,UnlimitedInt* b){
	// if(b->get_sign()==0){p=new UnlimitedInt(0);q=new UnlimitedInt(0);return;}
...
UnlimitedRational* UnlimitedRational::div(UnlimitedRational* a,UnlimitedRational* b){
	...
	// cout<<n->to_string()<<endl<<d->to_string()<<endl;
	return new UnlimitedRational(n,d);
}
#include <iostream>
int main(){
	UnlimitedRational *a=new UnlimitedRational(new UnlimitedInt(1),new UnlimitedInt(1)),*b=new UnlimitedRational(new UnlimitedInt(1),new UnlimitedInt(0));
