        ...
        for(int i = 0; i < N; i++) {
            ...
            try {
                if (elem == "push") {
                    ...
                    getline(outfile, output);
                    if(val != stoi(output)) {
                        cout << "Testcase failed get_element_from_top instruction " << (i+1) <<" "<<val<<" "<<stoi(output)<< endl;
                        return 0;
                    }
                }
                    ...
                    getline(outfile, output);
                    if(val != stoi(output)) {
                        cout << "Testcase failed subtraction instruction " << (i+1) <<" "<<val<<" "<<stoi(output)<< endl;
                        return 0;
                    }
                }
                    ...
                    getline(outfile, output);
                    if(val != stoi(output)) {
                        cout << "Testcase failed division instruction " << (i+1) <<" "<<val<<" "<<stoi(output)<< endl;
                        return 0;
                    }
                }
